...
Contributions to improve the Eletronics Store are welcome. Please follow these steps:

1. Fork the repository:
   ![fork](https://github.com/user-attachments/assets/40a18cf5-031e-4134-bd73-e87cf22b57aa)
2. Clone the fork (`git clone https://github.com/Diogo-Rodriigues/My_Eletronic_Store.git`)
3. Navigate to the project directory (`cd My_Eletronic_Store`)
